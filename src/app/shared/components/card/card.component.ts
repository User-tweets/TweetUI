...
export class CardComponent {
    ...
    getClasses(): string {
        ...
        if (this.variant === 'glass') {
            classes.push('bg-white/80 backdrop-blur-xl bg-clip-padding border border-white/20 rounded-2xl overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.12)]');
        } else {
            classes.push('bg-white rounded-2xl overflow-hidden border border-slate-100 shadow-[0_4px_20px_rgb(0,0,0,0.08)]');
        }
